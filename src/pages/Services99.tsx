      ...
      <div className="max-w-6xl mx-auto px-4 py-20">
        <div className="text-center mb-16">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-green-500/20 to-blue-500/20 backdrop-blur-md border border-green-500/30 mb-8">
            <span className="text-sm text-white/90">Need everything? Get the full Jumpstart Package for $499</span>
            <Link to="/#jumpstart">
            ...
            >
              ...
              <CardContent className="text-center">
                ...
                <Link to={service.link}>
                  <Button 
                    className={`w-full bg-gradient-to-r ${service.color} hover:opacity-90 text-white rounded-full`}
                  >
                    Learn More
        ...
        <Card className="bg-white/5 backdrop-blur-lg border-white/10 max-w-2xl mx-auto">
          <CardContent className="text-center p-8">
            ...
            <p className="text-white/70 mb-6">
              Get all services plus additional features in our comprehensive Jumpstart Package
            </p>
            <Link to="/#jumpstart">
              <Button 
                size="lg"
                className="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white px-8 py-6 text-lg rounded-full shadow-2xl shadow-purple-500/25 transition-all duration-300 hover:scale-105"
              >
                View Jumpstart Package ($499)
