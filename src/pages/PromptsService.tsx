...
const PromptsService = () => {
  const features = [
    "10 optimized AI prompts for your industry",
    "Custom prompt engineering for your brand",
    "Use cases and examples included",
    "ChatGPT, Claude, and Gemini compatible",
    "Bonus: Prompt optimization guide"
  ];
        ...
        <Card className="bg-white/5 backdrop-blur-lg border-white/10 mb-8">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="border-t border-white/10 pt-6">
              ...
              <Button 
                size="lg" 
                className="w-full bg-gradient-to-r from-yellow-600 to-orange-600 hover:from-yellow-700 hover:to-orange-700 text-white py-6 text-lg rounded-full shadow-2xl shadow-yellow-500/25 transition-all duration-300 hover:scale-105 mb-4"
